...
def move(my_history, their_history, my_score, their_score):
    ...
    '''If their previous move was collude, then betray them'''
    
    #scenario 1 - 
    if len(their_history) == 0: #this scenario happens on the first turn
        return 'c'
    #scenario 2 - 
    ...
    #scenario 3 - 
        ...
        return 'c'
    #scenario 4 - 
    elif len(my_score) <= their_score: #if their score is higher than yours, betray, else collude
        return 'b'
    else:
        return'c'
